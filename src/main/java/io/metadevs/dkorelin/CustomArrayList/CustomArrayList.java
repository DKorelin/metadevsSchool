...
public class CustomArrayList<T> implements List<T> {
    ...
    public CustomArrayList(T[] tArray) {
        size = tArray.length;
        this.elementData = new Object[size];
        System.arraycopy(tArray,0,this.elementData,0,size);
    }
    ...
    public List<T> subList(int fromIndex, int toIndex) {
        return new CustomArrayList<>((T[]) Arrays.copyOfRange(elementData,fromIndex,toIndex));
    }
